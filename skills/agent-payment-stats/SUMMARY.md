...
1. `agent-payment-stats quickstart` — invoke the skill in your assistant to load the routing prompt and confirm Barker's paid MCP at `mcp.barker.money` is reachable.
